...
// Tue Oct 19 01:01:25 2010 by ROOT version 5.22/00d
// from TTree EventTree/Event data
// found on file: Mu_Run2010B_PromptReco_146428to147114_GRV10.root
//////////////////////////////////////////////////////////

#ifndef Mu_Prompt_146428_h
#define Mu_Prompt_146428_h

#include <TROOT.h>
#include <TChain.h>
#include <TFile.h>

class Mu_Prompt_146428 {
public :
   ...
   Int_t           nMu;
   Int_t           muTrg[47][2];   //[nMu]
   Float_t         muEta[47];   //[nMu]
   Float_t         muPhi[47];   //[nMu]
   Int_t           muCharge[47];   //[nMu]
   Float_t         muPt[47];   //[nMu]
   Float_t         muPz[47];   //[nMu]
   Float_t         muIsoTrk[47];   //[nMu]
   Float_t         muIsoCalo[47];   //[nMu]
   Float_t         muIsoEcal[47];   //[nMu]
   Float_t         muIsoHcal[47];   //[nMu]
   Float_t         muChi2NDF[47];   //[nMu]
   Float_t         muEmVeto[47];   //[nMu]
   Float_t         muHadVeto[47];   //[nMu]
   Int_t           muType[47];   //[nMu]
   Bool_t          muID[47][6];   //[nMu]
   Float_t         muD0[47];   //[nMu]
   Int_t           muNumberOfValidTrkHits[47];   //[nMu]
   Int_t           muNumberOfValidPixelHits[47];   //[nMu]
   Int_t           muNumberOfValidMuonHits[47];   //[nMu]
   Int_t           muStations[47];   //[nMu]
   Int_t           muChambers[47];   //[nMu]
   Int_t           nZee;
   ...
   Mu_Prompt_146428(TTree *tree=0);
   virtual ~Mu_Prompt_146428();
...
#ifdef Mu_Prompt_146428_cxx
Mu_Prompt_146428::Mu_Prompt_146428(TTree *tree)
{
// if parameter tree is not specified (or zero), connect the file
// used to generate this class and read the Tree.
   if (tree == 0) {
      TFile *f = (TFile*)gROOT->GetListOfFiles()->FindObject("Mu_Run2010B_PromptReco_146428to147114_GRV10.root");
      if (!f) {
         f = new TFile("Mu_Run2010B_PromptReco_146428to147114_GRV10.root");
         f->cd("Mu_Run2010B_PromptReco_146428to147114_GRV10.root:/VgAnalyzerKit");
      }
...
Mu_Prompt_146428::~Mu_Prompt_146428()
{
   if (!fChain) return;
   delete fChain->GetCurrentFile();
}

Int_t Mu_Prompt_146428::GetEntry(Long64_t entry)
{
// Read contents of entry.
   if (!fChain) return 0;
   return fChain->GetEntry(entry);
}
Long64_t Mu_Prompt_146428::LoadTree(Long64_t entry)
{
...
void Mu_Prompt_146428::Init(TTree *tree)
{
...
Bool_t Mu_Prompt_146428::Notify()
{
...
void Mu_Prompt_146428::Show(Long64_t entry)
{
...
Int_t Mu_Prompt_146428::Cut(Long64_t entry)
{
...
#endif // #ifdef Mu_Prompt_146428_cxx
