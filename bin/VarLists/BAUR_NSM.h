   ...
   Int_t           nHFTowersN;
   Int_t           nVtx;
   Float_t         vtx[51][3];   //[nVtx]
   Int_t           vtxNTrk[51];   //[nVtx]
   Float_t         vtxNDF[51];   //[nVtx]
   Float_t         vtxD0[51];   //[nVtx]
   Int_t           nGoodVtx;
   Int_t           IsVtxGood;
   Int_t           nTrk;
   Int_t           nGoodTrk;
   ...
   Int_t           nMC;
   Int_t           mcPID[36];   //[nMC]
   Float_t         mcVtx[36][3];   //[nMC]
   Float_t         mcPt[36];   //[nMC]
   Float_t         mcMass[36];   //[nMC]
   Float_t         mcEta[36];   //[nMC]
   Float_t         mcPhi[36];   //[nMC]
   Int_t           mcGMomPID[36];   //[nMC]
   Int_t           mcMomPID[36];   //[nMC]
   Float_t         mcMomPt[36];   //[nMC]
   Float_t         mcMomMass[36];   //[nMC]
   Float_t         mcMomEta[36];   //[nMC]
   Float_t         mcMomPhi[36];   //[nMC]
   Int_t           mcIndex[36];   //[nMC]
   Int_t           mcDecayType[36];   //[nMC]
   Float_t         mcIsoDR03[36];   //[nMC]
   Float_t         mcCalIsoDR03[36];   //[nMC]
   Float_t         mcTrkIsoDR03[36];   //[nMC]
   Float_t         mcIsoDR04[36];   //[nMC]
   Float_t         mcCalIsoDR04[36];   //[nMC]
   Float_t         mcTrkIsoDR04[36];   //[nMC]
   Float_t         genMET;
   Float_t         genMETx;
   Float_t         genMETy;
   Float_t         genMETPhi;
   ...
   Int_t           nMu;
   Int_t           muTrg[21][16];   //[nMu]
   Float_t         muEta[21];   //[nMu]
   Float_t         muPhi[21];   //[nMu]
   Int_t           muCharge[21];   //[nMu]
   Float_t         muPt[21];   //[nMu]
   Float_t         muPz[21];   //[nMu]
   Int_t           muGenIndex[21];   //[nMu]
   Int_t           muGenGMomPID[21];   //[nMu]
   Int_t           muGenMomPID[21];   //[nMu]
   Float_t         muGenMomPt[21];   //[nMu]
   Float_t         muIsoTrk[21];   //[nMu]
   Float_t         muIsoCalo[21];   //[nMu]
   Float_t         muIsoEcal[21];   //[nMu]
   Float_t         muIsoHcal[21];   //[nMu]
   Float_t         muChi2NDF[21];   //[nMu]
   Float_t         muEmVeto[21];   //[nMu]
   Float_t         muHadVeto[21];   //[nMu]
   Int_t           muType[21];   //[nMu]
   Bool_t          muID[21][6];   //[nMu]
   Float_t         muD0[21];   //[nMu]
   Float_t         muDz[21];   //[nMu]
   Float_t         muPVD0[21];   //[nMu]
   Float_t         muPVDz[21];   //[nMu]
   Float_t         muValidFraction[21];   //[nMu]
   Float_t         muTrkdPt[21];   //[nMu]
   Int_t           muNumberOfHits[21];   //[nMu]
   Int_t           muNumberOfValidHits[21];   //[nMu]
   Int_t           muNumberOfInactiveHits[21];   //[nMu]
   Int_t           muNumberOfValidTrkHits[21];   //[nMu]
   Int_t           muNumberOfValidPixelHits[21];   //[nMu]
   Int_t           muNumberOfValidMuonHits[21];   //[nMu]
   Int_t           muStations[21];   //[nMu]
   Int_t           muChambers[21];   //[nMu]
   Float_t         muPV2D[21];   //[nMu]
   Float_t         muPV3D[21];   //[nMu]
   Float_t         muBS2D[21];   //[nMu]
   Float_t         muBS3D[21];   //[nMu]
   Float_t         muVtx[21][3];   //[nMu]
   Int_t           nJet;
