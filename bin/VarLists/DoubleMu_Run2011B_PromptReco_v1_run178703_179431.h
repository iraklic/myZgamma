   ...
   Int_t           nMu;
   Int_t           muTrg[52][16];   //[nMu]
   Float_t         muEta[52];   //[nMu]
   Float_t         muPhi[52];   //[nMu]
   Int_t           muCharge[52];   //[nMu]
   Float_t         muPt[52];   //[nMu]
   Float_t         muPz[52];   //[nMu]
   Float_t         muIsoTrk[52];   //[nMu]
   Float_t         muIsoCalo[52];   //[nMu]
   Float_t         muIsoEcal[52];   //[nMu]
   Float_t         muIsoHcal[52];   //[nMu]
   Float_t         muChi2NDF[52];   //[nMu]
   Float_t         muEmVeto[52];   //[nMu]
   Float_t         muHadVeto[52];   //[nMu]
   Int_t           muType[52];   //[nMu]
   Bool_t          muID[52][6];   //[nMu]
   Float_t         muD0[52];   //[nMu]
   Float_t         muDz[52];   //[nMu]
   Float_t         muPVD0[52];   //[nMu]
   Float_t         muPVDz[52];   //[nMu]
   Float_t         muValidFraction[52];   //[nMu]
   Float_t         muTrkdPt[52];   //[nMu]
   Int_t           muNumberOfHits[52];   //[nMu]
   Int_t           muNumberOfValidHits[52];   //[nMu]
   Int_t           muNumberOfInactiveHits[52];   //[nMu]
   Int_t           muNumberOfValidTrkHits[52];   //[nMu]
   Int_t           muNumberOfValidPixelHits[52];   //[nMu]
   Int_t           muNumberOfValidMuonHits[52];   //[nMu]
   Int_t           muStations[52];   //[nMu]
   Int_t           muChambers[52];   //[nMu]
   Float_t         muPV2D[52];   //[nMu]
   Float_t         muPV3D[52];   //[nMu]
   Float_t         muBS2D[52];   //[nMu]
   Float_t         muBS3D[52];   //[nMu]
   Float_t         muVtx[52][3];   //[nMu]
   Int_t           nJet;
