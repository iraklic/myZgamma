   ...
   Int_t           nJet;
   Int_t           jetTrg[36][23];   //[nJet]
   Float_t         jetEn[36];   //[nJet]
   Float_t         jetPt[36];   //[nJet]
   Float_t         jetEta[36];   //[nJet]
   Float_t         jetPhi[36];   //[nJet]
   Float_t         jetMass[36];   //[nJet]
   Float_t         jetEt[36];   //[nJet]
   Int_t           jetpartonFlavour[36];   //[nJet]
   Float_t         jetRawPt[36];   //[nJet]
   Float_t         jetRawEn[36];   //[nJet]
   Float_t         jetCharge[36];   //[nJet]
   Float_t         jetNeutralEmEnergy[36];   //[nJet]
   Float_t         jetNeutralEmEnergyFraction[36];   //[nJet]
   Float_t         jetNeutralHadronEnergy[36];   //[nJet]
   Float_t         jetNeutralHadronEnergyFraction[36];   //[nJet]
   Int_t           jetNConstituents[36];   //[nJet]
   Float_t         jetChargedEmEnergy[36];   //[nJet]
   Float_t         jetChargedEmEnergyFraction[36];   //[nJet]
   Float_t         jetChargedHadronEnergy[36];   //[nJet]
   Float_t         jetChargedHadronEnergyFraction[36];   //[nJet]
   Int_t           jetChargedHadronMultiplicity[36];   //[nJet]
   Float_t         jetChargedMuEnergy[36];   //[nJet]
   Float_t         jetChargedMuEnergyFraction[36];   //[nJet]
   Double_t        jetJVAlpha[36];   //[nJet]
   Double_t        jetJVBeta[36];   //[nJet]
   Int_t           jetGenJetIndex[36];   //[nJet]
   Float_t         jetGenJetEn[36];   //[nJet]
   Float_t         jetGenJetPt[36];   //[nJet]
   Float_t         jetGenJetEta[36];   //[nJet]
   Float_t         jetGenJetPhi[36];   //[nJet]
   Float_t         jetGenJetMass[36];   //[nJet]
   Int_t           jetGenPartonID[36];   //[nJet]
   Int_t           jetGenPartonMomID[36];   //[nJet]
   Int_t           nZee;
