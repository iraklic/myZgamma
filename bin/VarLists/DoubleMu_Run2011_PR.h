   ...
   Int_t           nJet;
   Int_t           jetTrg[52][58];   //[nJet]
   Float_t         jetEn[52];   //[nJet]
   Float_t         jetPt[52];   //[nJet]
   Float_t         jetEta[52];   //[nJet]
   Float_t         jetPhi[52];   //[nJet]
   Float_t         jetMass[52];   //[nJet]
   Float_t         jetEt[52];   //[nJet]
   Int_t           jetpartonFlavour[52];   //[nJet]
   Float_t         jetRawPt[52];   //[nJet]
   Float_t         jetRawEn[52];   //[nJet]
   Float_t         jetCharge[52];   //[nJet]
   Float_t         jetNeutralEmEnergy[52];   //[nJet]
   Float_t         jetNeutralEmEnergyFraction[52];   //[nJet]
   Float_t         jetNeutralHadronEnergy[52];   //[nJet]
   Float_t         jetNeutralHadronEnergyFraction[52];   //[nJet]
   Int_t           jetNConstituents[52];   //[nJet]
   Float_t         jetChargedEmEnergy[52];   //[nJet]
   Float_t         jetChargedEmEnergyFraction[52];   //[nJet]
   Float_t         jetChargedHadronEnergy[52];   //[nJet]
   Float_t         jetChargedHadronEnergyFraction[52];   //[nJet]
   Int_t           jetChargedHadronMultiplicity[52];   //[nJet]
   Float_t         jetChargedMuEnergy[52];   //[nJet]
   Float_t         jetChargedMuEnergyFraction[52];   //[nJet]
   Int_t           nZee;
