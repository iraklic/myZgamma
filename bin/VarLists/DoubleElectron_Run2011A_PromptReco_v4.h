   ...
   Int_t           nMu;
   Int_t           muTrg[34][16];   //[nMu]
   Float_t         muEta[34];   //[nMu]
   Float_t         muPhi[34];   //[nMu]
   Int_t           muCharge[34];   //[nMu]
   Float_t         muPt[34];   //[nMu]
   Float_t         muPz[34];   //[nMu]
   Float_t         muIsoTrk[34];   //[nMu]
   Float_t         muIsoCalo[34];   //[nMu]
   Float_t         muIsoEcal[34];   //[nMu]
   Float_t         muIsoHcal[34];   //[nMu]
   Float_t         muChi2NDF[34];   //[nMu]
   Float_t         muEmVeto[34];   //[nMu]
   Float_t         muHadVeto[34];   //[nMu]
   Int_t           muType[34];   //[nMu]
   Bool_t          muID[34][6];   //[nMu]
   Float_t         muD0[34];   //[nMu]
   Float_t         muDz[34];   //[nMu]
   Float_t         muPVD0[34];   //[nMu]
   Float_t         muPVDz[34];   //[nMu]
   Float_t         muValidFraction[34];   //[nMu]
   Float_t         muTrkdPt[34];   //[nMu]
   Int_t           muNumberOfHits[34];   //[nMu]
   Int_t           muNumberOfValidHits[34];   //[nMu]
   Int_t           muNumberOfInactiveHits[34];   //[nMu]
   Int_t           muNumberOfValidTrkHits[34];   //[nMu]
   Int_t           muNumberOfValidPixelHits[34];   //[nMu]
   Int_t           muNumberOfValidMuonHits[34];   //[nMu]
   Int_t           muStations[34];   //[nMu]
   Int_t           muChambers[34];   //[nMu]
   Float_t         muPV2D[34];   //[nMu]
   Float_t         muPV3D[34];   //[nMu]
   Float_t         muBS2D[34];   //[nMu]
   Float_t         muBS3D[34];   //[nMu]
   Float_t         muVtx[34][3];   //[nMu]
   Int_t           nJet;
