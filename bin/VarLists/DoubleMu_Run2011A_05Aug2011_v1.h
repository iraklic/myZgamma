   ...
   Int_t           nMu;
   Int_t           muTrg[162][16];   //[nMu]
   Float_t         muEta[162];   //[nMu]
   Float_t         muPhi[162];   //[nMu]
   Int_t           muCharge[162];   //[nMu]
   Float_t         muPt[162];   //[nMu]
   Float_t         muPz[162];   //[nMu]
   Float_t         muIsoTrk[162];   //[nMu]
   Float_t         muIsoCalo[162];   //[nMu]
   Float_t         muIsoEcal[162];   //[nMu]
   Float_t         muIsoHcal[162];   //[nMu]
   Float_t         muChi2NDF[162];   //[nMu]
   Float_t         muEmVeto[162];   //[nMu]
   Float_t         muHadVeto[162];   //[nMu]
   Int_t           muType[162];   //[nMu]
   Bool_t          muID[162][6];   //[nMu]
   Float_t         muD0[162];   //[nMu]
   Float_t         muDz[162];   //[nMu]
   Float_t         muPVD0[162];   //[nMu]
   Float_t         muPVDz[162];   //[nMu]
   Float_t         muValidFraction[162];   //[nMu]
   Float_t         muTrkdPt[162];   //[nMu]
   Int_t           muNumberOfHits[162];   //[nMu]
   Int_t           muNumberOfValidHits[162];   //[nMu]
   Int_t           muNumberOfInactiveHits[162];   //[nMu]
   Int_t           muNumberOfValidTrkHits[162];   //[nMu]
   Int_t           muNumberOfValidPixelHits[162];   //[nMu]
   Int_t           muNumberOfValidMuonHits[162];   //[nMu]
   Int_t           muStations[162];   //[nMu]
   Int_t           muChambers[162];   //[nMu]
   Float_t         muPV2D[162];   //[nMu]
   Float_t         muPV3D[162];   //[nMu]
   Float_t         muBS2D[162];   //[nMu]
   Float_t         muBS3D[162];   //[nMu]
   Float_t         muVtx[162][3];   //[nMu]
   Int_t           nJet;
   Int_t           jetTrg[59][23];   //[nJet]
   Float_t         jetEn[59];   //[nJet]
   Float_t         jetPt[59];   //[nJet]
   Float_t         jetEta[59];   //[nJet]
   Float_t         jetPhi[59];   //[nJet]
   Float_t         jetMass[59];   //[nJet]
   Float_t         jetEt[59];   //[nJet]
   Int_t           jetpartonFlavour[59];   //[nJet]
   Float_t         jetRawPt[59];   //[nJet]
   Float_t         jetRawEn[59];   //[nJet]
   Float_t         jetCharge[59];   //[nJet]
   Float_t         jetNeutralEmEnergy[59];   //[nJet]
   Float_t         jetNeutralEmEnergyFraction[59];   //[nJet]
   Float_t         jetNeutralHadronEnergy[59];   //[nJet]
   Float_t         jetNeutralHadronEnergyFraction[59];   //[nJet]
   Int_t           jetNConstituents[59];   //[nJet]
   Float_t         jetChargedEmEnergy[59];   //[nJet]
   Float_t         jetChargedEmEnergyFraction[59];   //[nJet]
   Float_t         jetChargedHadronEnergy[59];   //[nJet]
   Float_t         jetChargedHadronEnergyFraction[59];   //[nJet]
   Int_t           jetChargedHadronMultiplicity[59];   //[nJet]
   Float_t         jetChargedMuEnergy[59];   //[nJet]
   Float_t         jetChargedMuEnergyFraction[59];   //[nJet]
   Double_t        jetJVAlpha[59];   //[nJet]
   Double_t        jetJVBeta[59];   //[nJet]
   Int_t           nZee;
