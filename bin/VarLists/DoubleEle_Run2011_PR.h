   ...
   Int_t           nJet;
   Int_t           jetTrg[57][58];   //[nJet]
   Float_t         jetEn[57];   //[nJet]
   Float_t         jetPt[57];   //[nJet]
   Float_t         jetEta[57];   //[nJet]
   Float_t         jetPhi[57];   //[nJet]
   Float_t         jetMass[57];   //[nJet]
   Float_t         jetEt[57];   //[nJet]
   Int_t           jetpartonFlavour[57];   //[nJet]
   Float_t         jetRawPt[57];   //[nJet]
   Float_t         jetRawEn[57];   //[nJet]
   Float_t         jetCharge[57];   //[nJet]
   Float_t         jetNeutralEmEnergy[57];   //[nJet]
   Float_t         jetNeutralEmEnergyFraction[57];   //[nJet]
   Float_t         jetNeutralHadronEnergy[57];   //[nJet]
   Float_t         jetNeutralHadronEnergyFraction[57];   //[nJet]
   Int_t           jetNConstituents[57];   //[nJet]
   Float_t         jetChargedEmEnergy[57];   //[nJet]
   Float_t         jetChargedEmEnergyFraction[57];   //[nJet]
   Float_t         jetChargedHadronEnergy[57];   //[nJet]
   Float_t         jetChargedHadronEnergyFraction[57];   //[nJet]
   Int_t           jetChargedHadronMultiplicity[57];   //[nJet]
   Float_t         jetChargedMuEnergy[57];   //[nJet]
   Float_t         jetChargedMuEnergyFraction[57];   //[nJet]
   Int_t           nZee;
