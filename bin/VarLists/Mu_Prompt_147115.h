...
// Tue Oct 19 01:02:03 2010 by ROOT version 5.22/00d
// from TTree EventTree/Event data
// found on file: Mu_Run2010B_PromptReco_147115to147454_GRV10.root
//////////////////////////////////////////////////////////

#ifndef Mu_Prompt_147115_h
#define Mu_Prompt_147115_h

#include <TROOT.h>
#include <TChain.h>
#include <TFile.h>

class Mu_Prompt_147115 {
public :
   ...
   Int_t           nMu;
   Int_t           muTrg[50][2];   //[nMu]
   Float_t         muEta[50];   //[nMu]
   Float_t         muPhi[50];   //[nMu]
   Int_t           muCharge[50];   //[nMu]
   Float_t         muPt[50];   //[nMu]
   Float_t         muPz[50];   //[nMu]
   Float_t         muIsoTrk[50];   //[nMu]
   Float_t         muIsoCalo[50];   //[nMu]
   Float_t         muIsoEcal[50];   //[nMu]
   Float_t         muIsoHcal[50];   //[nMu]
   Float_t         muChi2NDF[50];   //[nMu]
   Float_t         muEmVeto[50];   //[nMu]
   Float_t         muHadVeto[50];   //[nMu]
   Int_t           muType[50];   //[nMu]
   Bool_t          muID[50][6];   //[nMu]
   Float_t         muD0[50];   //[nMu]
   Int_t           muNumberOfValidTrkHits[50];   //[nMu]
   Int_t           muNumberOfValidPixelHits[50];   //[nMu]
   Int_t           muNumberOfValidMuonHits[50];   //[nMu]
   Int_t           muStations[50];   //[nMu]
   Int_t           muChambers[50];   //[nMu]
   Int_t           nZee;
   ...
   Mu_Prompt_147115(TTree *tree=0);
   virtual ~Mu_Prompt_147115();
...
#ifdef Mu_Prompt_147115_cxx
Mu_Prompt_147115::Mu_Prompt_147115(TTree *tree)
{
// if parameter tree is not specified (or zero), connect the file
// used to generate this class and read the Tree.
   if (tree == 0) {
      TFile *f = (TFile*)gROOT->GetListOfFiles()->FindObject("Mu_Run2010B_PromptReco_147115to147454_GRV10.root");
      if (!f) {
         f = new TFile("Mu_Run2010B_PromptReco_147115to147454_GRV10.root");
         f->cd("Mu_Run2010B_PromptReco_147115to147454_GRV10.root:/VgAnalyzerKit");
      }
...
Mu_Prompt_147115::~Mu_Prompt_147115()
{
   if (!fChain) return;
   delete fChain->GetCurrentFile();
}

Int_t Mu_Prompt_147115::GetEntry(Long64_t entry)
{
// Read contents of entry.
   if (!fChain) return 0;
   return fChain->GetEntry(entry);
}
Long64_t Mu_Prompt_147115::LoadTree(Long64_t entry)
{
...
void Mu_Prompt_147115::Init(TTree *tree)
{
...
Bool_t Mu_Prompt_147115::Notify()
{
...
void Mu_Prompt_147115::Show(Long64_t entry)
{
...
Int_t Mu_Prompt_147115::Cut(Long64_t entry)
{
...
#endif // #ifdef Mu_Prompt_147115_cxx
