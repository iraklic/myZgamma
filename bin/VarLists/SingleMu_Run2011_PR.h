   ...
   Int_t           nHFTowersN;
   Int_t           nVtx;
   Float_t         vtx[35][3];   //[nVtx]
   Int_t           vtxNTrk[35];   //[nVtx]
   Int_t           vtxNDF[35];   //[nVtx]
   Float_t         vtxD0[35];   //[nVtx]
   Int_t           nGoodVtx;
   Int_t           IsVtxGood;
   Int_t           nTrk;
   Int_t           nGoodTrk;
   ...
   Float_t         muD0[46];   //[nMu]
   Float_t         muDz[46];   //[nMu]
   Float_t         muPVD0[46];   //[nMu]
   Float_t         muPVDz[46];   //[nMu]
   Float_t         muValidFraction[46];   //[nMu]
   Float_t         muTrkdPt[46];   //[nMu]
   Int_t           muNumberOfHits[46];   //[nMu]
   Int_t           muNumberOfValidHits[46];   //[nMu]
   Int_t           muNumberOfInactiveHits[46];   //[nMu]
   ...
   Float_t         muPV2D[46];   //[nMu]
   Float_t         muPV3D[46];   //[nMu]
   Float_t         muBS2D[46];   //[nMu]
   Float_t         muBS3D[46];   //[nMu]
   Float_t         muVtx[46][3];   //[nMu]
   Int_t           nJet;
   Int_t           jetTrg[56][58];   //[nJet]
   Float_t         jetEn[56];   //[nJet]
   Float_t         jetPt[56];   //[nJet]
   Float_t         jetEta[56];   //[nJet]
   Float_t         jetPhi[56];   //[nJet]
   Float_t         jetMass[56];   //[nJet]
   Float_t         jetEt[56];   //[nJet]
   Int_t           jetpartonFlavour[56];   //[nJet]
   Float_t         jetRawPt[56];   //[nJet]
   Float_t         jetRawEn[56];   //[nJet]
   Float_t         jetCharge[56];   //[nJet]
   Float_t         jetNeutralEmEnergy[56];   //[nJet]
   Float_t         jetNeutralEmEnergyFraction[56];   //[nJet]
   Float_t         jetNeutralHadronEnergy[56];   //[nJet]
   Float_t         jetNeutralHadronEnergyFraction[56];   //[nJet]
   Int_t           jetNConstituents[56];   //[nJet]
   Float_t         jetChargedEmEnergy[56];   //[nJet]
   Float_t         jetChargedEmEnergyFraction[56];   //[nJet]
   Float_t         jetChargedHadronEnergy[56];   //[nJet]
   Float_t         jetChargedHadronEnergyFraction[56];   //[nJet]
   Int_t           jetChargedHadronMultiplicity[56];   //[nJet]
   Float_t         jetChargedMuEnergy[56];   //[nJet]
   Float_t         jetChargedMuEnergyFraction[56];   //[nJet]
   Int_t           nZee;
   ...
   Int_t           nZmumu;
   Float_t         ZmumuMass[10];   //[nZmumu]
   Float_t         ZmumuPt[10];   //[nZmumu]
   Float_t         ZmumuEta[10];   //[nZmumu]
   Float_t         ZmumuPhi[10];   //[nZmumu]
   Int_t           ZmumuLeg1Index[10];   //[nZmumu]
   Int_t           ZmumuLeg2Index[10];   //[nZmumu]
   Int_t           nWenu;
